...
const taskName = 'distribute-retroactive-cashback' ;

@Injectable()
export class DistributeRetroactiveCashbackTaskHandler {
  constructor(
    private readonly commandBus: CommandBus,
    readonly redis: RedisService,
  ) {}

  @ConditionalCron('30 23 * * *', {
    name: taskName,
  })
  async handleRetroactiveCashback() {
