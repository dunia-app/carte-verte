...
export async function confirmCardPayment(
  command: ConfirmCardPaymentCommand,
  ...
  const confirmPaymentRes = cardPayment.confirmPayment()
  if (confirmPaymentRes.isErr) {
    return Result.err(confirmPaymentRes.error)
  }
