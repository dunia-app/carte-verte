...
const route = 'expire-pending-accepted-transactions';
...
@Injectable()
@SkipJWTAuth()
export class ExpirePendingAcceptedTransactionsController {
    constructor(
    ...
    @Post()
    async ExpirePendingAcceptedTransactions(@Response() res: FastifyReply): Promise<void> {
