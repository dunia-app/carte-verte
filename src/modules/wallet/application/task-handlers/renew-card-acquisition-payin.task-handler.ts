...
import { RenewCardAcquisitionPayinCommand } from '../../commands/renew-card-acquisition-payin/renew-card-acquisition-payin.command';
...
@Injectable()
export class RenewCardAcquisitionPayinTaskHandler {
  constructor(
  ...
  async handleRenewCardAcquisitionPayinToBeAuthorized() {
